...
public class LinkedListTest {
    ...
    @Test public void checkInsert1() {
        list.insert(10);
        assertEquals("It should insert the value in the beginning of the list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> 10 -> NULL", list.toString());
    }
    ...
    @Test public void checkInsert2() {
        ...
        assertEquals("It should insert multiple values in the beginning of the linked list in the order they were received","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> 10 -> 20 -> 30 -> 40 -> NULL", list.toString());
    }
    ...
    {
        assertEquals("It should return the string version of the linked list", "HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> NULL", list.toString());
    }

    //Challenge 06
    @Test public void addAtEndTest() {
        list.append(70);
        assertEquals("It should append the value at the end of the linked list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> 70 -> NULL", list.toString());
    ...
    @Test public void addMultipleAtEndTest() {
        ...
        list.append(76);
        list.append(77);
        assertEquals("It should add multiple values at the end of the linked list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> 71 -> 72 -> 73 -> 74 -> 75 -> 76 -> 77 -> NULL", list.toString());

    }

    @Test public void addInBeforeMiddleTest() {
        list.insertBefore(19,20);
        assertEquals("It should add new value before the given value in the linked list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 20 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> NULL", list.toString());
    }

    @Test public void addInBeforeFirstTest() {
        list.insertBefore(60,20);
        assertEquals("It should add new value before the given value in the linked list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 20 -> 60 -> NULL", list.toString());
    }

    @Test public void addInAfterMiddleTest()  {
        list.insertAfter(19, 100);
        assertEquals("It should add new value after the given value in the linked list","HEAD -> 1 -> 4 -> 7 -> 13 -> 17 -> 19 -> 100 -> 23 -> 29 -> 37 -> 59 -> 60 -> NULL", list.toString());
    }

    @Test public void addInAfterLastTest() {
        list.insertAfter(1, 100);
        assertEquals("It should add new value after the given value in the linked list","HEAD -> 1 -> 100 -> 4 -> 7 -> 13 -> 17 -> 19 -> 23 -> 29 -> 37 -> 59 -> 60 -> NULL", list.toString());
    }
    ...
    @Test public void kthFromEndTest() {
        ...
        assertEquals("It should return the last element of the linked list",60, list.kFromEnd(0));
        assertEquals("It should return the first element of the linked list",1, list.kFromEnd(10));
